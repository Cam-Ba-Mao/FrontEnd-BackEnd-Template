    ...
    <section class="hero is-primary">
        <div class="hero-body">
            <div class="container has-text-centered">
                <h1 class="title is-3 is-family-secondary is-uppercase"><?php esc_html_e( 'Search Results for:', 'iknow' ); ?></h1>
                <h2 class="subtitle is-6"><?php echo esc_attr( get_search_query() ); ?></h2>
            </div>
        </div>
    </section>
